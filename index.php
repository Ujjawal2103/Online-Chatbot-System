...
<!-- <body style="background-color:#bdc3c7"> -->
	...
	<div id="main-wrapper">
		...
		<form class="myform" action="index.php" method="post">
			...
			<input class="login_btn" name="login" type="submit" id="login_btn" value="Login"/><br>
			

			<a href="register.php"><input class="register_btn" type="button" id="register_btn" value="Register"/></a> <br>
			
			<a href="admin.php"><input class="admin_btn_hp" type="button" id="admin_btn" value=" Login as Admin"/></a>
